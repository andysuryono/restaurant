...
<head>
  ...
  <title>{{ $title or 'KitchenFood' }}</title>

  <!-- Bootstrap CSS -->    
  <link href="{{ asset('adm/bootstrap-3.2.0/css/bootstrap.min.css') }}" rel="stylesheet" />
  <!-- bootstrap theme -->
  ...
  <!-- font icon -->
  <link href="{{ asset('adm/icon-fonts/font-awesome-4.3.0/css/font-awesome.min.css') }}" rel="stylesheet" />   
  ...
  <link href="{{ asset('adm/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css') }}" rel="stylesheet" />
  <link rel="stylesheet" href="{{ asset('assets/css/magnific-popup.css') }}">
  <link rel="stylesheet" href="{{ asset('adm/css/ekko-lightbox.css') }}">
  <!-- full calendar css-->
  ...
  <!-- owl carousel -->
  <link rel="stylesheet" href="{{ asset('adm/css/owl.carousel.css') }}" type="text/css" />
...
<!-- <script src="{{ asset('adm/js/jquery-1.8.3.min.js') }}"></script> -->
...
<script src="{{ asset('adm/js/owl.carousel.js') }}" ></script>
<!-- jQuery full calendar -->
<script src="{{ asset('adm/js/fullcalendar.min.js') }}"></script> <!-- Full Google Calendar - Calendar -->
